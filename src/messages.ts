...
const cgnStart1 = {
  ...
  markdown:
    '---\nit:\n    cta_1: \n        text: "Richiedi la Carta"\n        action: "ioit://CTA_START_CGN"\nen:\n    cta_1: \n        text: "Claim the Card"\n        action: "ioit://CTA_START_CGN"\n---\n\n\nSe sei un **cittadino italiano o europeo residente in Italia** e hai **tra i 18 e i 35 anni** di età, puoi attivare la Carta Giovani Nazionale.\n\nLa Carta Giovani Nazionale, promossa dal Dipartimento per le Politiche Giovanili e il Servizio Civile Universale della Presidenza del Consiglio dei Ministri, **consente di ottenere agevolazioni per accedere a beni, servizi, esperienze e opportunità di carattere culturale, formativo, sportivo e ricreativo su tutto il territorio nazionale**.\n\nPuoi attivarla tramite IO, oppure visualizzare maggiori dettagli sul [sito dedicato](https://giovani2030.it/iniziativa/carta-giovani-nazionale/).\n\nPer poter richiedere la tua Carta Giovani Nazionale, devi avere aggiornato IO all\'ultima versione disponibile dall\'[App Store](https://apps.apple.com/it/app/io/id1501681835) o dal [Play Store](https://play.google.com/store/apps/details?id=it.pagopa.io.app)\n\n',
};
